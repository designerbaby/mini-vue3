...
async function build(options) {
    const { root = process.cwd(), base = '/', outDir = path_1.default.resolve(root, 'dist'), assetsDir = '_assets', assetsInlineLimit = 4096, cssCodeSplit = true, alias = {}, resolvers = [], rollupInputOptions = {}, rollupOutputOptions = {}, emitIndex = true, emitAssets = true, write = true, minify = true, 
    // default build transpile target is es2019 so that it transpiles
    // optional chaining which terser doesn't handle yet
    esbuildTarget = 'es2019', enableEsbuild = true, silent = false, sourcemap = false, shouldPreload = null, env = {}, mode: configMode = 'production', define: userDefineReplacements, cssPreprocessOptions, cssModuleOptions = {} } = options;
    ...
    const bundle = await rollup({
        ...
        plugins: [
            ...
            enableEsbuild
                ? buildPluginEsbuild_1.createEsbuildRenderChunkPlugin(esbuildTarget, minify === 'esbuild')
                : undefined,
            // minify with terser
